...
@AnalyzeClasses(packages = "com.github.dropguard.loom", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {

    @ArchTest
    static final ArchRule no_core_http_client_request = noClasses()
    ...
    @ArchTest
    static final ArchRule no_core_http_client_response = noClasses()
            .should().dependOnClassesThat()
    ...
    @ArchTest
    static final ArchRule no_getDelegate_escape = noClasses()

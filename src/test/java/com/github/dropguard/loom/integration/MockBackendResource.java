        ...
        server = vertx.createHttpServer()
                ...
                .requestHandler(req -> {
                    ...
                    if ("/health".equals(path)) {
                        ...
                        vertx.setTimer(1500, id -> req.response()
                                .setStatusCode(200)
                                .end(new JsonObject().put("slow", true).encode()));
                        ...
                        JsonObject json = new JsonObject()
                                .put("x_user_id", req.getHeader("X-User-Id"))
                                .put("x_claim_scope", req.getHeader("X-Claim-scope"));
                        json(req, json);
                    } else {

...
public record RouteConfig(
    ...
    public record FilterConfig(
        ...
        public static final FilterConfig EMPTY = new FilterConfig(null, null, null, null, null, null, null);
        ...
        public List<String> forwardClaims() {
            return claimsForward != null && claimsForward.claims() != null
                    ? claimsForward.claims() : List.of("sub");
        }
        ...
        public static class Builder {
            ...
            public FilterConfig build() {
                return new FilterConfig(auth, rateLimit, circuitBreaker, cache, gray, timeout, claimsForward);
            }
        }
    }
    ...
    public record ClaimsForwardConfig(
            List<String> claims) {
    }

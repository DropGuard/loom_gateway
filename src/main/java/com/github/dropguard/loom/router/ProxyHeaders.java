...
final class ProxyHeaders {
    ...
    static Map<String, String> buildForwardHeaders(
            List<Map.Entry<String, String>> incoming, Map<String, Object> claims, List<String> forwardClaims) {
        ...
        if (claims != null && !claims.isEmpty()) {
            List<String> which = (forwardClaims != null && !forwardClaims.isEmpty())
                    ? forwardClaims : List.of("sub");
